...
|--------------|-----------------------------------------------------------------------------------------------------------|------------------------|---------------------------------|
| 2.53.4       |  [v0.197.0](https://github.com/Furtif/POGOProtos/blob/master/base/v0.197.0_p_obf.proto)                         | **Partial Obfuscated** (_/base/v0.197.0_p_obf.proto_)  |  Protocol Buffers v3.14.0     |
